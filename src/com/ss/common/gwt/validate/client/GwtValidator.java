...
public class GwtValidator {
	...
	private GwtValidatorForm form;

	public GwtValidator(GwtValidatorMessagesProvider messagesProvider) {
		if (messagesProvider == null) {
			throw new IllegalArgumentException(GwtValidatorMessagesProvider.class.getName() + " is required parameter");
		}
	...
	public <T> GwtValidator field(Element el, ValidatorValueProvider<T> value, List<Validator<T>> validators) {
		GwtValidatorField<T> fld = new GwtValidatorField<T>(el, value);
